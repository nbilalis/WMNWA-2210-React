...
var App = function () { return (React.createElement(React.Fragment, null,
    ...
    React.createElement(react_router_dom_1.Routes, null,
        ...
        React.createElement(react_router_dom_1.Route, { path: "/products/" },
            React.createElement(react_router_dom_1.Route, { index: true, element: React.createElement(List_1["default"], null) }),
            React.createElement(react_router_dom_1.Route, { path: ":id", element: React.createElement(Details_1["default"], null) }))))); };
exports["default"] = App;
